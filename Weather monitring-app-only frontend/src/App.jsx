...
const WeatherDashboard = () => {
  ...
  const fetchAirQualityData = (lat, lon) => {
    const API_KEY = '0198cd08d3848ac86de381ed8c9153ba'; // Replace with your OpenWeatherMap API key
  ...
  return (
    <div>
      ...
      {weatherData && airQualityData &&  (
        <div style={{ display: "flex", padding: "30px", gap: "20px" ,backgroundColor:"#42247e", flexWrap:"wrap", height:"700px"}}>
          <div style={{ flex: "1", marginRight: "10px", paddingLeft:"40px",paddingTop:"48px" }}>
            <MainWeatherCard weatherData={weatherData} />
            <p style={{ fontWeight: "700", fontSize: "20px", marginTop: "30px" , color:"White" ,marginBottom:"30px"}}>5 Days Forecast</p>
