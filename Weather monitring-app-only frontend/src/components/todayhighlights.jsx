  ...
  return (
    <div
      style={{
        ...
        borderRadius: "0.5rem",
        padding: "30px",
        backdropFilter:"blur(11px) saturate(28%)",
        marginTop:"42px",
        WebkitBackdropFilter:"blur(11px) saturate(28%)",
        //backgroundColor: rgba(40, 37, 17, 0.26)
        flexWrap:"wrap",
        paddingRight:"30px",
        height:"520px"
      }}
    >
      <div style={{ fontSize: "20px", marginTop:"30px", marginBottom:"30px"}}>Today's Highlights</div>
      <div
        style={{
          display: "flex",
          gap: "18px",
